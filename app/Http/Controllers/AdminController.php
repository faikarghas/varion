...
class AdminController extends Controller
{
    ...
    public function post_subsidiaries(Request $request,$id){
        ...
        $dataInput = [
            ...
            'imageBack' => $imageName2,
            'imageHome' => $imageName3,
            'imagHome1' => $imageName4,
            'imagHome2' => $imageName5,
            'imageHeader1' => $imageName6,
            'imageHeader2' => $imageName7,
            'imageInvesment' => $imageName8,
            'imageBusiness' => $imageName9,
            'imageCapital' => $imageName10,
            'imageFooter' => $imageName11,
            'imageFooter2' => $imageName12,
        ];
